...
public class CharacterCreatorScreen : MonoBehaviour
{
    ...
    // Campos indexados para salvar/carregar fichas sem depender da hierarquia visual.
    ...
    // Referencias usadas para montar resumos e barras principais.
    ...
    private void BuildDnDForm()
    {
        ...
        dndRace = CreateField(dndRT, x, y, 310f, "RACA", "dnd_race");
        dndClass = CreateField(dndRT, x + 325f, y, 310f, "CLASSE", "dnd_class");
        dndLevel = CreateField(dndRT, x + 650f, y, 310f, "NIVEL", "dnd_level");
        y -= 80f;

        CreateField(dndRT, x, y, 472.5f, "ANTECEDENTE", "dnd_bkg");
        CreateField(dndRT, x + 487.5f, y, 472.5f, "TENDENCIA", "dnd_align");
        y -= 90f;
        ...
        CreateField(dndRT, x + (aw + ag) * 0, y, aw, "FORCA", "dnd_str");
        CreateField(dndRT, x + (aw + ag) * 1, y, aw, "DESTREZA", "dnd_dex");
        CreateField(dndRT, x + (aw + ag) * 2, y, aw, "CONSTITUICAO", "dnd_con");
        CreateField(dndRT, x + (aw + ag) * 3, y, aw, "INTELIGENCIA", "dnd_int");
        ...
        CreateField(dndRT, x + (cbW + cbGap) * 3, y, cbW, "BONUS PROFICIENCIA", "dnd_prof");
        CreateField(dndRT, x + (cbW + cbGap) * 4, y, cbW, "INSPIRACAO", "dnd_insp");
        y -= 90f;

        VTTLayout.LabelFixed(dndRT, x, y, 960f, 20f, 14f, cDnd, FontStyles.Bold, TextAlignmentOptions.BottomLeft).text = "PERICIAS";
        y -= 25f;
        string[] dndSkills = { "Acrobacia", "Arcanismo", "Atletismo", "Atuacao", "Enganacao", "Furtividade", "Historia", "Intimidacao", "Intuicao", "Investigacao", "Lidar Animais", "Medicina", "Natureza", "Percepcao", "Persuasao", "Prestidigitacao", "Religiao", "Sobrevivencia" };
        ...
        VTTLayout.LabelFixed(dndRT, x, y, 472.5f, 20f, 14f, cDnd, FontStyles.Bold, TextAlignmentOptions.BottomLeft).text = "TRACOS E CARACTERISTICAS";
        ...
        Button btnSpells = VTTLayout.BtnFixed(dndRT, x, y, 960f, 40f, "MAGIAS E ESPACOS DE MAGIA", VTTLayout.C_BTN_SEC, VTTLayout.C_BDR_DEFAULT, cDnd, 14f, true);
        ...
        CreateField(spRT, x + 645f, sy, 300f, "BONUS DE ATAQUE", "dnd_magic_atk");
        sy -= 80f;

        VTTLayout.LabelFixed(spRT, x + 15f, sy, 465f, 20f, 14f, cDnd, FontStyles.Bold, TextAlignmentOptions.BottomLeft).text = "ESPACOS DE MAGIA (SLOTS)";
    ...
    private void BuildOrdemForm()
    {
        ...
        CreateField(ordemRT, x + (aw + ag) * 3, y, aw, "PRESENCA", "ord_pre");
        CreateField(ordemRT, x + (aw + ag) * 4, y, aw, "FORCA", "ord_for");
        y -= 85f;
        ...
        VTTLayout.LabelFixed(ordemRT, x, y, 960f, 20f, 14f, cOrdem, FontStyles.Bold, TextAlignmentOptions.BottomLeft).text = "PERICIAS";
        y -= 25f;
        string[] ordemSkillsList = { "Acrobacia", "Adestramento", "Artes", "Atletismo", "Atualidades", "Ciencias", "Crime", "Diplomacia", "Enganacao", "Fortitude", "Furtividade", "Iniciativa", "Intimidacao", "Intuicao", "Investigacao", "Luta", "Medicina", "Ocultismo", "Percepcao", "Pilotagem", "Pontaria", "Profissao", "Reflexos", "Religiao", "Sobrevivencia", "Tatica", "Tecnologia", "Vontade" };
        ...
        VTTLayout.LabelFixed(ordemRT, x + 487.5f, y, 472.5f, 20f, 14f, cOrdem, FontStyles.Bold, TextAlignmentOptions.BottomLeft).text = "INVENTARIO (Peso/Espacos)";
        y -= 25f;
    ...
    private void DoPickAvatar()
    {
        ...
        if (MapFileLoader.Instance != null)
        {
            MapFileLoader.Instance.OpenFilePicker((tex) => {
                // Descarta textura temporaria quando o usuario troca a imagem antes de salvar.
