// ============================================================
// DashboardOverlay.cs
// Ecr� inteiro de Gerenciamento de Personagens.
...
public class DashboardOverlay : MonoBehaviour
{
    ...
    private void BuildCharacterCard(RectTransform parent, string name, string subText, string statsFormatado, Texture2D avatarTex)
    {
        ...
        // O Texto Din�mico de Stats (Fonte tamanho 12f para caber todos os stats)
    ...
    private void BuildAddCard(RectTransform parent)
    {
        ...
        btn.onClick.AddListener(() => {
            // O seletor de sistema deve aparecer ACIMA do Dashboard.
            // O Dashboard so sera escondido depois que o usuario escolher o sistema.
    ...
    public void RefreshDashboard()
    {
        ...
        // CORRE��O: Calcula a altura da grid UMA vez s�, em vez de 60 vezes por segundo no Update
        UpdateGridHeight();
    }
...
// Destr�i o Sprite de v�deo/RAM automaticamente quando o objeto da UI for apagado
public class SpriteCleanup : MonoBehaviour
{
    ...
    private void OnDestroy()
    {
        ...
        Texture2D tex = spriteToDestroy.texture;
